const FilterList = (generateFilterItemsHTML, filterType, filters) => {
  return `
    <ul class="filter__list">
      <div class="flex items-center ps-0 pe-3 border border-neutral-400 bg-white rounded-sm sticky top-0 focus-within:ring ring-accent ">
      ...
      <ul class="filter__items | js-filter-results">
