  ...
  return `
    <ul class="filter__list">
      <div class="flex items-center mb-2 mx-4 ps-0 pe-3 border border-neutral-400 bg-white rounded-sm sticky top-0 focus-within:ring ring-accent ">
        <label class="sr-only" for="${filterType}-attributs-search">Rechercher un ${filterType}</label>
        <input type="search" id="${filterType}-attributs-search" class="py-1 px-2 w-full focus:outline-none | js-filter-list" />
